...
const Analytics = () => {
  return (
    ...
    //             <img
    //               src={masinIcon}
    //               className="p-5 w-16 bg-slate-50 shadow-lg shadow-slate-300 border rounded-lg "
    //               alt=""
    //             />
    ...
    <section className="mx-auto max-w-6xl flex justify-center  items-center my-32 ">
...
{/* section start */}
        <div>
          <h2
            style={{ color: "#0070FF", backgroundColor: "#E5F1FF" }}
            className="text-xs px-4 py-3  font-semibold w-28 rounded-xl tracking-widest mb-4"
          >
            ANALYTICS{" "}
          </h2>
          <h2 style={{ color: "#181E28" }} className="text-2xl mb-2">
          ...
          <div className="flex flex-col gap-6 ">
            <div className="flex gap-6">
              <img
                src={masinIcon}
                className="p-5 w-16 bg-slate-50 shadow-lg shadow-slate-300 border border-teal-200 rounded-lg "
                alt=""
              />
              <div className="flex flex-col ">
                <h5 className="text-xm font-semibold text-slate-500">
