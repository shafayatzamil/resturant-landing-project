        ...
        <div className="card lg:card-side bg-base-100 shadow-xl mb-4">
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              <figure>
                <img
                  src="https://images.unsplash.com/photo-1600891965050-6da6bad77c3f?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=871&q=80"
            ...
            <div>
              <div className="flex justify-between p-2 ">
                <div>
                  <h2 className="font-extrabold">
                    Avoburger <br /> Mackey Street 7, NY
                  </h2>
                </div>
                <div>
                  <svg
              ...
              <p className="text-xs px-2 mb-2 text-[#AEAEAE]">
                Open 10:00am - 09:00pm, Mon-Sat{" "}
              </p>
        ...
        <div className="card lg:card-side bg-base-100 shadow-xl mb-4">
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              <figure>
                <img
                  src="https://images.unsplash.com/photo-1414235077428-338989a2e8c0?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTB8fHJlc3R1cmFudHN8ZW58MHx8MHx8&auto=format&fit=crop&w=400&q=60"
                  className="rounded-l-lg "
                  alt="Album"
                />
              </figure>
        ...
        <div className="card lg:card-side bg-base-100 shadow-xl mb-4">
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              <figure>
                <img
                  src="https://images.unsplash.com/photo-1555992457-b8fefdd09069?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NXx8cmVzdHVyYW50c3xlbnwwfHwwfHw%3D&auto=format&fit=crop&w=400&q=60"
                  className="rounded-l-lg "
                  alt="Album"
                />
              </figure>
